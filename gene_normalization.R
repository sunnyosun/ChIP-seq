# GENE Normalization of ChIP-seq data
# Sunny

gene_norm<-function(folder, Name)
{
# load the gff file (saved as txt by excel)
out=read.table('~/../../Volumes/LabShare/Sunny/data_analysis/sk1_genome/SK1_annotation_modified.txt')

# load the wiggle file
#folder = 'AH119B-053013_MACS_wiggle_norm'
...
color=color_s
pdf(file=paste('~/Desktop/', folder, '-', '_gene_norm_plot.pdf', sep=""), width=10, height=8)
...
pdf(file=paste('~/Desktop/', folder, '-', '_gene_norm_ave_plot.pdf', sep=""), width=10, height=8)
